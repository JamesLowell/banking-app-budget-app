            ...
            <form className='flex items-center flex-col p-4 fixed ml-[7rem]' onSubmit={handleFormSubmit}>
                <div className='border-[1px] rounded-lg py-16 px-8 relative flex flex-wrap gap-4 mb-8'>
                    ...
                    <label htmlFor='last-name' className='w-[30%] font-abril text-2xl'> Last Name
                        <input type='text' id='last-name' name='last-name' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]'
                        value = {user.lastName} 
                        onChange={(e) => {
                    ...
                    <label htmlFor='first-name' className='w-[30%] font-abril text-2xl'> First Name
                        <input type='text' id='first-name' name='first-name' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]'
                ...
                <div className='border-[1px] rounded-lg py-16 px-8 relative flex flex-wrap gap-4 mb-8'>
                    ...
                    <label htmlFor='house-number' className='w-full font-abril text-2xl'> House Number / Subdivision 
                        <input type='text' id='house-number' name='house-number' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]'
                    ...
                    <label htmlFor='city' className='w-[30%] font-abril text-2xl'> City
                        <input type='text' id='city' name='city' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg  w-[70%]'
                    ...
                    <label htmlFor='province' className='w-[30%] font-abril text-2xl'> Province
                        <input type='text' id='province' name='province' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]'
                    ...
                    <label htmlFor='country' className='w-[30%] font-abril text-2xl'> Country
                        <input type='text' id='country' name='country' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]'
                ...
                <div className='border-[1px] rounded-lg py-16 px-8 relative flex flex-wrap gap-4 mb-8'>
                    ...
                    <label htmlFor='email' className='w-[100%] font-abril text-2xl'> Email
                        <input type='email' id='email' name='email' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]' value={user.email} 
                        onChange={(e) => {
                    ...
                    <label htmlFor='password' className='w-[100%] font-abril text-2xl'> Password
                        <input type='password' id='password' name='password' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]' defaultValue={`${''}`}
                        onChange={e => {
                    ...
                    <label htmlFor='repeat-password' className='w-[100%] font-abril text-2xl'> Repeat your Password
                        <input type='password' id='repeat-password' name='repeat-password' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]' defaultValue={`${''}`}
                        onChange={e => {

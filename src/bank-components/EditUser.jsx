...
//same loader as the customer info page
        ...
        <Form className='flex items-center flex-col p-4' onSubmit={handleFormSubmit}>
            ...
            <div className='border-[1px] rounded-lg py-16 px-8 relative flex flex-wrap gap-4 mb-8'>
                ...
                <label htmlFor='password' className='w-[100%] font-abril text-2xl'> Password
                    <input type='password' id='password' name='password' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]' defaultValue={user.password} required/>
                </label>
                {
                ...
                <label htmlFor='repeat-password' className='w-[100%] font-abril text-2xl'> Repeat your Password
                    <input type='password' id='repeat-password' name='repeat-password' className='border-[1px] rounded-lg p-2 ml-4 font-mulish text-lg w-[70%]' defaultValue={user.reTypePassword} required/>
                </label>           
                {
